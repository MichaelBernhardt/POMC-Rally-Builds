                              ...
                              <div key={day.id} style={{ marginTop: '2px' }}>
                                ...
                                <div
                                  ...
                                  style={{
                                    ...
                                    cursor: 'pointer',
                                    borderRadius: '4px',
                                    background: isSelectedDay && (viewMode === 'grid' || viewMode === 'routeBuilder') ? 'var(--color-primary-light)' : 'transparent',
                                    fontWeight: isSelectedDay && (viewMode === 'grid' || viewMode === 'routeBuilder') ? 600 : 400,
                                    color: isSelectedDay && (viewMode === 'grid' || viewMode === 'routeBuilder') ? 'var(--color-primary)' : undefined,
                                    fontSize: '13px',
                                    display: 'flex',
                                    justifyContent: 'space-between',
                                    alignItems: 'center',
